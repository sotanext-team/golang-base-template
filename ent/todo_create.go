...
func (tc *TodoCreate) SetID(u uint64) *TodoCreate {
	tc.mutation.SetID(u)
	return tc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (tc *TodoCreate) SetNillableID(u *uint64) *TodoCreate {
	if u != nil {
		tc.SetID(*u)
	}
	return tc
...
func (tc *TodoCreate) AddChildIDs(ids ...uint64) *TodoCreate {
...
func (tc *TodoCreate) SetParentID(id uint64) *TodoCreate {
...
func (tc *TodoCreate) SetNillableParentID(id *uint64) *TodoCreate {
	if id != nil {

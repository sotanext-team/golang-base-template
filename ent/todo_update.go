...
func (tu *TodoUpdate) AddChildIDs(ids ...uint64) *TodoUpdate {
...
func (tu *TodoUpdate) SetParentID(id uint64) *TodoUpdate {
...
func (tu *TodoUpdate) SetNillableParentID(id *uint64) *TodoUpdate {
	if id != nil {
...
func (tu *TodoUpdate) RemoveChildIDs(ids ...uint64) *TodoUpdate {
...
// AddChildIDs adds the "children" edge to the Todo entity by IDs.
func (tuo *TodoUpdateOne) AddChildIDs(ids ...uint64) *TodoUpdateOne {
...
// SetParentID sets the "parent" edge to the Todo entity by ID.
func (tuo *TodoUpdateOne) SetParentID(id uint64) *TodoUpdateOne {
	tuo.mutation.SetParentID(id)
	return tuo
}

// SetNillableParentID sets the "parent" edge to the Todo entity by ID if the given value is not nil.
func (tuo *TodoUpdateOne) SetNillableParentID(id *uint64) *TodoUpdateOne {
	if id != nil {
...
// RemoveChildIDs removes the "children" edge to Todo entities by IDs.
func (tuo *TodoUpdateOne) RemoveChildIDs(ids ...uint64) *TodoUpdateOne {

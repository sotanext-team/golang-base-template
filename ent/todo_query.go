...
func (tq *TodoQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (tq *TodoQuery) FirstIDX(ctx context.Context) uint64 {
...
func (tq *TodoQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (tq *TodoQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (tq *TodoQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (tq *TodoQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
